...
public class MaximaFactory extends LatinFactory {
	...
	private static final int[] DEFAULT_CREDIT_ARRAY = new int[] { 1, 3, 5, 2, 1, 5, 3, 3, 2, 6, 4, 4, 4, 1, 2, 5, 7,
			2, 3, 2, 3, 4, 5, 7, 7, 5 };
